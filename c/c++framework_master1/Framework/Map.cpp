...
{
	strcpy_s(_Maze[0],  "21111101111111111111110011111001111111110000000000");
	strcpy_s(_Maze[1],  "10000100000010010000100010000000000000010000000000");
	...
	strcpy_s(_Maze[12], "01011010001000000000111100111111111111100000000000");
	...
	strcpy_s(_Maze[17], "00100000000000000000000000001000000000100000111000");
	strcpy_s(_Maze[18], "00100000000000000000000000001000000000100000100000");
	strcpy_s(_Maze[19], "00100000000000000000000000001000000000100000100000");
	strcpy_s(_Maze[20], "00111111111111111110000000001111111111111111100000");
	strcpy_s(_Maze[21], "00000010000000000000000000000000000000100000100000");
	strcpy_s(_Maze[22], "00011111111111111111111111111111111111111111111111");
	strcpy_s(_Maze[23], "00000000000000000000000000000000000000000000100010");
	strcpy_s(_Maze[24], "00000000000000000000000000000000000000000000110013");
}
